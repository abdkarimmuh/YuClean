...
import andara.heatcliff.yuclean.RegistrasiActivityCount;
...
public class LoginActivity extends AppCompatActivity{
    ...
    public static final String url = "http://yuclean.andara-tech.com/api/auth/login";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(LoginActivity.this, "Silahkan Coba Lagi", Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
